            ...
            <div className="px-[6%]">
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <Link href="https://www.linkedin.com/in/samikshadsawant" className="text-sm text-[darkText1] underline underline-offset-4">
                            <div>@RTCT 2024, All rights reserved.</div>
                        </Link>
                        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <Link href="https://www.linkedin.com/in/samikshadsawant/" target="_blank" className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <Link href="https://www.instagram.com/" target="_blank" className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
